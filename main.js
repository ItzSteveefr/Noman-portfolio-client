...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const MOCK_REVIEWS = [
        { name: "Crxyon_", text: "High-quality thumbnail delivered within a short time frame. Great attention to detail and overall finish.", stars: 5, pfp: "" },
        { name: "ZeorPlayzX", text: "Extremely professional design with eye-catching colors and perfect text placement. The video vibe was crystal clear.", stars: 5, pfp: "" },
        { name: "Craftopia Conqueror", text: "Outstanding thumbnail quality with very fast delivery. One of the best thumbnail creators I’ve seen.", stars: 5, pfp: "" },
        { name: "MrScaft", text: "Creative and impressive work that clearly stands out. Loved the final result.", stars: 5, pfp: "" },
        { name: "SAMAR YT", text: "Quick delivery with excellent animation quality. Strong teamwork and solid execution.", stars: 5, pfp: "" },
    ];
